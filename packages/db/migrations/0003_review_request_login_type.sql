...
CREATE TABLE review_requests (
  ...
  review_type TEXT NOT NULL CHECK (review_type IN ('FINAL_SUBMIT','ANSWER','DOCUMENT','OTP','AMBIGUOUS_QUESTION','CAPTCHA','MFA','LOGIN')),
...
CREATE INDEX IF NOT EXISTS idx_review_requests_run ON review_requests(application_run_id, status);
